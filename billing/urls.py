...
# from .views import invoice_form, search_invoice, send_invoice_email , print_invoice
...
# ]
from django.urls import path
from .views import invoice_form, search_invoice, send_invoice_email, get_invoice , invoice_detail
